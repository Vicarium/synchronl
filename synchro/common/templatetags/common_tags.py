...
# Retrieves the side menu items - the immediate children of the parent page
# The has_menu_children method is necessary because the bootstrap menu requires
# a dropdown class to be applied to a parent
@register.inclusion_tag("common/tags/side_menu.html", takes_context=True)
...
# Retrieves the children of the side menu items for the drop downs
@register.inclusion_tag("common/tags/side_menu_children.html", takes_context=True)
